...
tuits %>% 
  ...
  labs(title = 'Ratio de tuits',
       caption = "Alberto Fernández & Axel Kicillof (Frente de Todos) \n Mauricio Macri & M.E. Vidal (Juntos por el Cambio)",
...
```{r rtweet, echo=TRUE, message=FALSE, warning=FALSE, paged.print=FALSE}

  
  library(rtweet)

consulta <- get_timelines(user = c("mauriciomacri", "alferdez", "kicillofok", "mariuvidal"),
                          n = 100)
