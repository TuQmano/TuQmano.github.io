...
Twitter es un gran lugar para estar conectado con las novedades de [#rstats](https://twitter.com/search?q=rstatsES). Y `LatinR` nos dió la posibilidad de poder ponerle cara a un montón de `@rrobas` con los que uno interactua cotidianamente en esa conexión. Algo de todo esto se pudo vivir a través de twitter detrás del _hashtag_ `#LatinR2019`. Los gráficos de abajo son una muestra de eso.    
