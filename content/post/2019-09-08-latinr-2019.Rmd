...
Los próximos 25, 26 y 27 de septiembre se desarrollará en Santiago de Chile la segunda edición de _[LatinR](https://latin-r.com/): Conferencia Latinoamericana sobre el uso de `R` en I+D_. Tuve la suerte de participar en la primera edición, que se llevó a cabo en Buenos Aires hace un año, donde pude mostrar un pequeño proyecto -aún en desarrollo- que consiste en el desarrollo de _mapas como si fueran grillas_ (`geofacet`) aplicados a divisiones políticas de Argentina (a nivel país y provincial) [^1]

[^1]: Esto decíamos en un post previo: [ _geofaceteAR_ ](https://tuqmano.github.io/2019/01/21/geofacetear/)

Gracias al apoyo del comité evaluador tendré la oportunidad de participar nuevamente en esta segunda edición. En esta ocasión mostraré un trabajo en el que trabajamos con el colega y tocayo JP Pilorget para _menta Comunicación_. Un _dashboard_ de `Shiny` que permite la visualización rápida y centralizada de variables electorales, de interés para el análisis político y el desarrollo de campañas electorales (proyecto en desarrollo). 
...
2. el procesamiento de los datos para estructurar las bases de datos y la generación de los gráficos con el _suite_ `Tidyverse` (`dplyr`, `tidyr`, `ggplot`, etc), 
